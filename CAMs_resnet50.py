...
optimizer = torch.optim.AdamW(params=trainable_parameters, lr=0.0001)  
...
torch.save(model.state_dict(), 'resnet50_100epochs_ImageNet.pt')
"=============================================================================="
...
for fname in range(1):#IMG_URL:
    with torch.no_grad():
        fname = '93.png'#{2,7,8,10,17,25,27,28,31,39,42} 
